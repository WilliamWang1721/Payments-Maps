...
import { useCardAlbumStore, type AlbumScope, type CardAlbumItem } from '@/stores/useCardAlbumStore'
...
const CardAlbum = () => {
  ...
  const cards = useCardAlbumStore((state) => state.cards)
  const addCard = useCardAlbumStore((state) => state.addCard)
