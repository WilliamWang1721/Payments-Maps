...
import { Crown, Shield, Users, User, Edit, Save, X, Search, Zap, Plus, Eye, EyeOff, Copy, Trash2, MapPin } from 'lucide-react'
...
const RoleManagement = () => {
  ...
  useEffect(() => {
    ...
    if (permissions.isAdmin) {
      if (!permissions.canManageRoles && activeTab === 'codes') {
        setActiveTab('users')
      }
      void loadUsers()
      if (permissions.canManageRoles && activeTab === 'codes') {
  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="p-4 space-y-4">
        ...
        {/* 激活码管理标签页内容 */}
        {activeTab === 'codes' && permissions.canManageRoles && (
          <>
            {/* 创建激活码按钮 */}
            <Card>
              <CardContent className="pt-6">
