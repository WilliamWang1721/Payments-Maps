...
import type { CreateLocationInput, LocationStatus } from "@/types/location";
...
function FloatingBanner({
  ...
  return (
    <div
      className={`ui-banner-enter pointer-events-none flex max-w-[min(92vw,560px)] items-center gap-3 rounded-pill border px-4 py-2.5 shadow-[0_22px_50px_-32px_rgba(15,23,42,0.45)] backdrop-blur-xl ${
...
function StepOneContent({
  ...
  return (
    <div className="relative flex min-h-0 min-w-0 flex-1 flex-col gap-6 px-4 pb-4 pt-4 sm:px-6 lg:px-8 xl:flex-row xl:gap-8 xl:px-12 xl:pb-8 xl:pt-6">
      <div className="pointer-events-none absolute left-1/2 top-1 z-20 flex -translate-x-1/2 flex-col items-center gap-2 px-4">
        {successBannerVisible ? (
          <FloatingBanner
            banner={{ status: "success", title: t("Merchant name auto-filled") }}
      ...
      <div className="flex w-full flex-col gap-6 xl:w-[min(440px,34vw)] xl:shrink-0">
        ...
        <CardFrame title="Billing Settings">
          ...
          <Field isSelect label="Brand" onChange={(value) => onFieldChange("brand", value)} options={brandOptions} placeholder="Select brand" value={draft.brand} />
        </CardFrame>
      </div>
