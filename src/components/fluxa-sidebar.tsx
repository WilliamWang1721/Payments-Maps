...
export function FluxaSidebar({
  ...
  const desktopSidebarWidth = collapsedLabels ? "md:w-[88px] md:basis-[88px]" : "md:w-[clamp(248px,20vw,272px)] md:basis-[clamp(248px,20vw,272px)]";
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className={`flex-1 truncate text-right text-sm font-medium leading-6 text-[var(--sidebar-accent-foreground)] md:text-base ${desktopLabelVisibility}`}>{t("Map")}</span>
        </button>
        ...
        >
          ...
          <span className={`flex-1 truncate text-right text-sm font-medium leading-6 text-[var(--sidebar-accent-foreground)] md:text-base ${desktopLabelVisibility}`}>{t("List")}</span>
        </button>
        ...
        >
          ...
          <span className={`flex-1 truncate text-right text-sm font-medium leading-6 text-[var(--sidebar-accent-foreground)] md:text-base ${desktopLabelVisibility}`}>{t("Brands")}</span>
        </button>
